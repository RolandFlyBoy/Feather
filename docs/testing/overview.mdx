...
description: "Every project is scaffolded with tests that pass. There's nothing to configure before you write the first one."
icon: "flask-conical"
---

Tests are scaffolded with the project and pass from the first run. The setup that usually
stands between you and a first test, a configured client, a test database and fixtures for
both, is already written.
