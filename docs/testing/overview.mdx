...
Tests are scaffolded with the project, and they pass from the first run. That matters more
than it sounds: the awkward part of testing a new framework is usually the setup, and it's
already done.
