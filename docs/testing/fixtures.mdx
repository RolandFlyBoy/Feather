---
title: "Fixtures"
description: "Two test clients, one of them CSRF-aware, and how to add your own fixtures for common test data."
icon: "plug"
---
...
<Note>
  ...
  `csrf_client` fixture fetches and includes the token so your tests do not have to.
</Note>
