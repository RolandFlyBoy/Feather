---
title: "Test database"
description: "Each test gets a clean database. Plus one fixture mistake that makes every request resolve to the same user."
icon: "database"
---
...
## A fixture mistake that is easy to misread
