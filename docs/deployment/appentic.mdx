...
<Steps>
  <Step title="Create a project and choose a machine" icon="server">
    In Appentic, create a project, open **Resources** and choose a machine. A shared CPU
    machine with 2 vCPU and 4 GB runs a Feather app, its worker, Postgres and Redis.
  </Step>
